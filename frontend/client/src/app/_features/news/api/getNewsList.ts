...
// データを取得する関数
export const getNewsList = async(): Promise<NewsType[]> =>{
    try {
       const data: any = await fetch(`https://${process.env.NEXT_PUBLIC_MICROCMS_SERVICE_ID}.microcms.io/api/v1/news?limit=100`,  {
        headers: {
